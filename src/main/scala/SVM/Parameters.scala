...
/**
  ...
  */
case class AlgoParams(maxIter: Int = 100, minDeltaAlpha: Double = 0.01, learningRateDecline: Double = 0.5, batchProb: Double = 0.8, epsilon : Double = 0.0001, isDebug: Boolean = false, quantileAlphaClipping: Double = 0.0) extends Parameters{
